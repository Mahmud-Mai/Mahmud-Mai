...
export const skillData = [
  ...
  { index: 5, imgSrc: next, skillName: "Next JS" },
  { index: 6, imgSrc: html, skillName: "html" },
  { index: 7, imgSrc: css, skillName: "css" },
  { index: 8, imgSrc: javascript, skillName: "Javascript" },
  { index: 9, imgSrc: mui, skillName: "MUI" },
  { index: 10, imgSrc: chakraui, skillName: "chakra Ui" },
  { index: 11, imgSrc: tailwind, skillName: "tailwind" },
  { index: 12, imgSrc: redux, skillName: "redux" },
  { index: 13, imgSrc: sass, skillName: "sass" },
  { index: 14, imgSrc: git, skillName: "git" },
  { index: 15, imgSrc: wordpress, skillName: "wordpress" },
  { index: 16, imgSrc: wordpress, skillName: "next" },
];
